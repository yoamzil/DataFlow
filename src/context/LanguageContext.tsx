...
const translations = {
	en: {
		...
		'form.errors.exist': 'Client with this ID card already exists with different name',
	...
	fr: {
		...
		'form.errors.exist': 'Un client avec cette carte d\'identité existe déjà avec un nom différent',
